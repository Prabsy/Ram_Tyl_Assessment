...
Examples:
  ...
  $ open
  $ open -b webkit https://demoqa.com/automation-practice-form`);
...
Examples:
  ...
  $ codegen -b webkit https://demoqa.com/automation-practice-form`);
...
Examples:
  ...
  $ ${alias} https://demoqa.com/automation-practice-form`);
}
commandWithOpenOptions(
...
Examples:
  ...
  $ screenshot -b webkit https://demoqa.com/automation-practice-form example.png`);
commandWithOpenOptions(
  "pdf <url> <filename>",
  "save page as pdf",
  [
...
Examples:
  ...
  $ pdf https://demoqa.com/automation-practice-form example.pdf`);
...
Examples:
  ...
  $ show-trace https://demoqa.com/automation-practice-form/trace.zip`);
