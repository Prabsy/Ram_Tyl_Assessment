...
export interface Page {
   ...
   * const requestPromise = page.waitForRequest('https://demoqa.com/automation-practice-form/resource');
   * await page.getByText('trigger request').click();
   * const request = await requestPromise;
   *
   * // Alternative way with a predicate. Note no await.
   * const requestPromise = page.waitForRequest(request =>
   *   request.url() === 'https://demoqa.com/automation-practice-form' && request.method() === 'GET',
   * );
   * await page.getByText('trigger request').click();
   * const request = await requestPromise;
   * ```
   ...
   * const responsePromise = page.waitForResponse('https://demoqa.com/automation-practice-form/resource');
   * await page.getByText('trigger response').click();
   * const response = await responsePromise;
   *
   * // Alternative way with a predicate. Note no await.
   * const responsePromise = page.waitForResponse(response =>
   *   response.url() === 'https://demoqa.com/automation-practice-form' && response.status() === 200
...
export interface BrowserContext {
  ...
  grantPermissions(permissions: ReadonlyArray<string>, options?: {
    /**
     * The [origin] to grant permissions to, e.g. "https://demoqa.com/automation-practice-form".
     */
    origin?: string;
  }): Promise<void>;
...
export interface APIRequestContext {
   ...
   *
   * ```js
   * await request.fetch('https://demoqa.com/automation-practice-form/api/createBook', {
   *   method: 'post',
   *   data: {
   *     title: 'Book Title',
   *     author: 'John Doe',
   ...
   * await request.fetch('https://demoqa.com/automation-practice-form/api/uploadForm', {
   *   multipart: form
   * });
   * ```
   *
   ...
   * await request.get('https://demoqa.com/automation-practice-form/api/getText', {
   *   params: {
   *     'isbn': '1234',
   *     'page': 23,
   *   }
   ...
   * await request.get('https://demoqa.com/automation-practice-form/api/getText', { params: searchParams });
   *
   * // Passing params as string
   * const queryString = 'isbn=1234&page=23&page=24';
   * await request.get('https://demoqa.com/automation-practice-form/api/getText', { params: queryString });
   * ```
   *
   * @param url Target URL.
   * @param options
   ...
   *
   * ```js
   * await request.post('https://demoqa.com/automation-practice-form/api/createBook', {
   *   data: {
   *     title: 'Book Title',
   *     author: 'John Doe',
   *   }
   ...
   *
   * ```js
   * await request.post('https://demoqa.com/automation-practice-form/api/findBook', {
   *   form: {
   *     title: 'Book Title',
   *     author: 'John Doe',
   *   }
   ...
   * form.append('file', new File(['console.log(2024);'], 'f1.js', { type: 'text/javascript' }));
   * form.append('file', new File(['hello'], 'f2.txt', { type: 'text/plain' }));
   * await request.post('https://demoqa.com/automation-practice-form/api/uploadForm', {
   *   multipart: form
   * });
   * ```
   *
...
export interface Request {
   ...
   * **Usage**
   *
   * For example, if the website `http://example.com` redirects to `https://demoqa.com/automation-practice-form`:
   *
   * ```js
